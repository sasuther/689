...
public:
	...
	void setEyeViewUp(const vmr::Vector& eye, const vmr::Vector& view, const vmr::Vector& up);
	const vmr::Vector& eye() const { return position; }
	const vmr::Vector& view() const { return axis_view; }
	const vmr::Vector& up() const { return axis_up; }
	...
	const vmr::Vector view(const double x, const double y);
...
private:
	...
	vmr::Vector position;
	vmr::Vector axis_right, axis_up, axis_view;
